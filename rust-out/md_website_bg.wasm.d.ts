...
export function wasm_bindgen__convert__closures__invoke1_mut__h38b53f778116c328(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h13b8e6ae1589bee8(a: number, b: number, c: number, d: number): void;
