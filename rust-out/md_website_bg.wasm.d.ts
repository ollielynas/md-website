...
export function wasm_bindgen__convert__closures__invoke1_mut__h9728eeb74eac84ce(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h8f548d927c7371e2(a: number, b: number, c: number, d: number): void;
