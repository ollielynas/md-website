/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-dark&languages=markup+css+clike+javascript+brainfuck+c+csharp+cpp+haskell+java+python+rust&plugins=line-numbers+toolbar+copy-to-clipboard */
var _self =
